...
shop_app.shop.add_url_rule('/shop/', view_func = shop_app.render_shop, methods = ["GET", "POST"])
...
shop_app.shop.add_url_rule("/shop/filter", view_func = shop_app.filter_product, methods = ["GET", "POST"])
